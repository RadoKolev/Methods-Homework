...
class NumberCalculations
{
    static void Main()
    {
        ...
        var doubleNumbers = new[] {input.CompareTo(' ')};
        double[] arr = new double[doubleNumbers.Length];
        for (int i = 0; i < doubleNumbers.Length; i++)
        {
            arr[i] = double.Parse(doubleNumbers[i].ToString());
        }

        // reading decimal
        string inputDecimal = Console.ReadLine();
        string[] decimalNumbers = inputDecimal.Split(' ');
        decimal[] arrDecimal = new decimal[decimalNumbers.Length];
        for (int i = 0; i < decimalNumbers.Length; i++)
        {
            arrDecimal[i] = decimal.Parse(decimalNumbers[i]);
        }
    ...
    private static double GetMin(int[] doubleNumbers)
    {
    ...
    private static double GetMax(int[] arr)
    {
    ...
    private static double GetProduct(int[] arr)
    {
        double product = 1;
        for (int i = 0; i < arr.Length; i++)
        {
